...
{
	shaderPrg = EZCOGL::ShaderProgram::create({{GL_VERTEX_SHADER, EZCOGL::load_src(SHADERS_PATH + "/TP3.vs")}, {GL_FRAGMENT_SHADER, EZCOGL::load_src(SHADERS_PATH + "/TP3.fs")}}, "VBOs");
	...
	grid_rend = meshGrid->renderer(1, -1, 2, -1, -1);
	...
	tex->load(DATA_PATH+"/IcelandHeightmap.png",false);
...
void Viewer::draw_ogl()
{
	...
	EZCOGL::set_uniform_value(3, heightScale);
	EZCOGL::set_uniform_value(4, colorMap);
